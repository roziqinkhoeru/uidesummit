...
<head>
    ...
    <link
        href="<?= base_url('assets/css/styles-user.css'); ?>"
        rel="stylesheet" />
</head>
...
<body id="page-top">
    ...
    <nav class="navbar navbar-expand-lg navbar-light fixed-top shadow-sm" id="mainNav">
        <div class="container px-5">
            <a class="navbar-brand fw-bold" href="#page-top">UIDESUMMIT 2022</a>
                    ...
                    <div class="card" style="width: 100%;">
                        <div class="card-body">
                            ...
                            <button type="button" class="btn btn-primary" data-bs-toggle="modal"
                                data-bs-target="#event_<?= $event['id_event']; ?>">
                                Register now!
                            </button>
    ...
    <div class="modal fade"
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <form
                    action="/saveRegister/<?= $event['id_event']; ?>"
                    method="post">
    ...
    <!-- Core theme JS-->
    <script
        src="<?= base_url('assets/js/scripts-user.js'); ?>">
    </script>
    <!-- * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * *-->
    <!-- * *                               SB Forms JS                               * *-->
